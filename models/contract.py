...
class Contract(Model):
    ...
    worker_name = fields.CharField(max_length=128, null=False)
    ...
    work_rest = fields.IntField(null=False)
    work_working_days = fields.CharField(max_length=128, null=False)
    work_days_off = fields.CharField(max_length=128, null=False)
    work_leave = fields.IntField(null=False)
    work_other_leave = fields.TextField(null=False)
    utilities = fields.CharField(max_length=128, null=False)
    housing_accomodation = fields.CharField(max_length=128, null=False) #new
    housing_cost = fields.IntField(null=False)
    ...
    job_criteria_degree = fields.CharField(max_length=128, null=False)
    job_criteria_jlpt_level = fields.CharField(max_length=128, null=False)
    job_criteria_year_exp = fields.CharField(max_length=128, null=False)
    job_criteria_other = fields.TextField(null=False)
    ...
    benefits_housing = fields.CharField(max_length=128, null=False)
    benefits_utilities = fields.CharField(max_length=128, null=False)
    benefits_transportation = fields.CharField(max_length=128, null=False)
    benefits_other = fields.TextField(null=False)
